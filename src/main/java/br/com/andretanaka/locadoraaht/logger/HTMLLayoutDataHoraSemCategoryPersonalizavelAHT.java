...
public class HTMLLayoutDataHoraSemCategoryPersonalizavelAHT extends Layout {
	...
	sbuf.append(sdf.format(new Date(event.timeStamp)));			//sbuf.append(event.timeStamp - LoggingEvent.getStartTime());
